...
from assets.modules.windows import open_settings_window
from assets.modules.file_dialog import select_hoi4_dir_callback, select_mod_dir_callback
...
with dpg.window(width=694, height=611, no_title_bar=True, no_resize=True, no_close=True, no_move=True):
    with dpg.group(horizontal=True):
        ...
        for module in listdir('modules'):
            try:
                imported_module = importlib.import_module(f'modules.{module.split(".")[0]}')
